...
public class RabbitMQTransport implements Transport {
	...
	@Override
    public Object request(String targetComponentKey, Class<? extends RController> rControllerClass, Method method, Object[] args, long timeout) {
...
//			if (resultClass!=null) {
//				classReturnType = Class.forName(response.getAsString("result_class"), true, Thread.currentThread().getContextClassLoader());
//			} else {
